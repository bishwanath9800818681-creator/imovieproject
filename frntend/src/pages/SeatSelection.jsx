    ...
    <div className="min-h-screen bg-gradient-to-r from-red-500 via-yellow-400 to-red-500 text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center space-x-4 mb-8">
          <button
            onClick={() => navigate(-1)}
            className="p-2 rounded-lg border border-yellow-300 hover:bg-yellow-100 hover:text-red-600 transition-colors"
          >
            <ArrowLeft className="h-5 w-5" />
          </button>
          <div>
            <h1 className="text-3xl font-bold">Select Seats</h1>
            <p className="text-yellow-200">Showtime: {showtime}</p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 sticky top-24">
              ...
              {selectedSeats.length > 0 ? (
                <div className="space-y-4">
                  <div>
                    <h4 className="font-medium mb-2 flex items-center space-x-2 text-gray-900">
                      ...
                      {Object.entries(
                        ...
                        <div key={type} className="bg-gray-100 p-3 rounded-lg">
                          <div className="flex justify-between items-center mb-1">
                            ...
                            <span className="text-sm text-gray-900">₹{data.price} x {data.count}</span>
                          </div>
