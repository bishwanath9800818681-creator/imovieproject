...
const Header = ({ user, onLogout, selectedLocation, setSelectedLocation }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-gradient-to-r from-red-600 via-red-700 to-red-800 shadow-xl z-50">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-2">
            <div className="bg-gradient-to-r from-purple-700 to-indigo-700 text-white px-3 py-2 rounded-lg font-bold text-xl hover:from-indigo-700 hover:to-purple-700 transition-colors cursor-pointer">
              IMovie
            </div>
          </Link>
          ...
          <div className="relative z-50">
            ...
            >
              ...
              <span className="text-sm font-medium truncate max-w-32 text-gray-900">
          ...
          <div className="flex items-center space-x-4">
            {user ? (
              ...
              <div className="hidden md:flex items-center space-x-2">
                <Link
                  to="/login"
                className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-indigo-700 transition-colors rounded-lg hover:bg-indigo-100"
              >
                Sign In
              </Link>
              <Link
                to="/register"
                className="px-6 py-2 bg-gradient-to-r from-purple-700 to-indigo-700 text-white text-sm font-medium rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
              >
                Sign Up
              </Link>
              </div>
